...
def eval_agnews(eval_model_name, self_defined_description=False):
...
def eval_yahoo(eval_model_name, self_defined_description=False):
    labels = [
        "Society", "Culture",
        "Science", "Mathematics",
        "Health",
...
def eval_dbpedia(eval_model_name, self_defined_description=False):
...
def main():
    # best case
    print("agnews, default descriptive label",
          eval_agnews(eval_model_name="../checkpoints/agnews"))
    print("agnews, self-defined descriptive label",
          eval_agnews(eval_model_name="../checkpoints/agnews", self_defined_description=True))
    print("yahoo, default descriptive label",
          eval_yahoo(eval_model_name="../checkpoints/yahoo"))
    print("yahoo, self-defined descriptive label",
          eval_yahoo(eval_model_name="../checkpoints/yahoo", self_defined_description=True))
    print("dbpedia, default descriptive label",
          eval_dbpedia(eval_model_name="../checkpoints/dbpedia"))
    print("dbpedia, self-defined descriptive label",
          eval_dbpedia(eval_model_name="../checkpoints/dbpedia", self_defined_description=True))
