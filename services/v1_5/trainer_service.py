...
class TrainerService:
    def __init__(self):
        ...
        with h5py.File("../../embeddings/all-mpnet-base-v2/v1_5/wiki_text_embeddings.h5", "r") as f:
    ...
    def save_wiki_text_embeddings():
        ...
        # 儲存嵌入到 HDF5 檔案
        with h5py.File("../../embeddings/all-mpnet-base-v2/v1_5/wiki_text_embeddings.h5", 'w') as hf:
            hf.create_dataset('embeddings', data=embeddings)
